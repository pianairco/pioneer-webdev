...
@Handler
public class ErrorHandler<Res> extends BaseRequestHandler<ErrorHandler.Request, Res> {
...
//    @Transactional(propagation = Propagation.REQUIRED)
    ...
    public CommonResponse provideResponse(
            ...
            HandlerInterStateTransporter transporter) throws HandlerRuntimeException {
