...
public class NatsConnectionProps {
    ...
    /**
     * Whither or not the server will send messages sent from this connection back
     * to the connection.
     */
    private boolean noEcho;

    /**
     * Whither or not to treat subjects as UTF-8, the default is ASCII.
     */
    private boolean utf8Support;

    /**
     * Authentication username. Requires the password, but not the token, or
     * credentials, or NKey.
     */
    ...
    /**
     * Path the SSL trust store, for verifying the server.
     */
    ...
    /**
     * Provider Algorithm for the SSL key store, for verifying the server.
     */
    ...
    /**
     * @return whither or not to block echo messages, messages that were sent by
     * this connection
     */
    ...
    /**
     * @return whither or not the client should support for UTF8 subject names
     */
    ...
    /**
     * @param utf8Support whither or not the client should support for UTF8 subject
     *                    names
     */
     ...
     */
    public NatsConnectionProps server(String serverURL) {
     ...
     * @return chainable properties
     */
    public NatsConnectionProps connectionName(String connectionName) {
        this.connectionName = connectionName;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps maxReconnect(int maxReconnect) {
        this.maxReconnect = maxReconnect;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps reconnectWait(Duration reconnectWait) {
        this.reconnectWait = reconnectWait;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps connectionTimeout(Duration connectionTimeout) {
        this.connectionTimeout = connectionTimeout;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps pingInterval(Duration pingInterval) {
        this.pingInterval = pingInterval;
        return this;
    }

    public NatsConnectionProps requestCleanupInterval(Duration requestCleanupInterval) {
        this.requestCleanupInterval = requestCleanupInterval;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps reconnectBufferSize(long reconnectBufferSize) {
        this.reconnectBufferSize = reconnectBufferSize;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps username(String username) {
        this.username = username;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps password(String password) {
        this.password = password;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps token(String token) {
        this.token = token;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps nkey(String nkey) {
        this.nkey = nkey;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps inboxPrefix(String inboxPrefix) {
        this.inboxPrefix = inboxPrefix;
        return this;
    }

    /**
     * @param noEcho whither or not to send messages published by this connection
     *               back to it's subscribers
     * @return chainable properties
     */
    public NatsConnectionProps noEcho(boolean noEcho) {
        this.noEcho = noEcho;
        return this;
    }

    /**
     * @param utf8Support whither or not to support utf8 subject names
     * @return chainable properties
     */
    public NatsConnectionProps utf8Support(boolean utf8Support) {
        this.utf8Support = utf8Support;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps credentials(String credentials) {
        this.credentials = credentials;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps keyStorePath(String keyStorePath) {
        this.keyStorePath = keyStorePath;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps keyStorePassword(char[] keyStorePassword) {
        this.keyStorePassword = keyStorePassword;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps trustStorePath(String trustStorePath) {
        this.trustStorePath = trustStorePath;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps trustStorePassword(char[] trustStorePassword) {
     ...
     * @return chainable properties
     */
    public NatsConnectionProps keyStoreType(String keyStoreType) {
        this.keyStoreType = keyStoreType;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps keyStoreProvider(String keyStoreProvider) {
        this.keyStoreProvider = keyStoreProvider;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps trustStoreType(String trustStoreType) {
        this.trustStoreType = trustStoreType;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps trustStoreProvider(String trustStoreProvider) {
        this.trustStoreProvider = trustStoreProvider;
        return this;
    }
     ...
     * @return chainable properties
     */
    public NatsConnectionProps tlsProtocol(String tlsProtocol) {
        this.tlsProtocol = tlsProtocol;
        return this;
    }
    ...
    public Options.Builder toOptionsBuilder() throws IOException, GeneralSecurityException {
        ...
        builder = builder.requestCleanupInterval(this.requestCleanupInterval);
